...
<body>
    ...
    <div class="table-monitoring">
        <table class="table_produksi">
            ...
            <tr>
                <?php 
                    $sql = "SELECT * FROM table_monitoring_common_rail_1 order by id desc LIMIT 1";
            ...
            <tr>
                <?php 
                    $sql = "SELECT * FROM table_monitoring_common_rail_2 order by id desc LIMIT 1";
                    $statement = $connection->query($sql);
                    foreach ($statement as $row){
            ...
            <tr>
                <?php 
                    $sql = "SELECT * FROM table_monitoring_common_rail_3 order by id desc LIMIT 1";
                    $statement = $connection->query($sql);
                    foreach ($statement as $row){
            ...
            <tr>
                <?php 
                    $sql = "SELECT * FROM table_monitoring_common_rail_4 order by id desc LIMIT 1";
                    $statement = $connection->query($sql);
                    foreach ($statement as $row){
            ...
            <tr>
                <?php 
                    $sql = "SELECT * FROM table_monitoring_common_rail_5 order by id desc LIMIT 1";
                    $statement = $connection->query($sql);
                    foreach ($statement as $row){
            ...
            <tr>
                <?php 
                    $sql = "SELECT * FROM table_monitoring_common_rail_6 order by id desc LIMIT 1";
                    $statement = $connection->query($sql);
                    foreach ($statement as $row){
            ...
            <tr>
                <?php 
                    $sql = "SELECT * FROM table_monitoring_common_rail_7 order by id desc LIMIT 1";
                    $statement = $connection->query($sql);
                    foreach ($statement as $row){
            ...
            <tr>
                <?php 
                    $sql = "SELECT * FROM table_monitoring_common_rail_8 order by id desc LIMIT 1";
                    $statement = $connection->query($sql);
                    foreach ($statement as $row){
            ...
            <tr>
                <?php 
                    $sql = "SELECT * FROM table_monitoring_common_rail_9 order by id desc LIMIT 1";
                    $statement = $connection->query($sql);
                    foreach ($statement as $row){
            ...
            <tr>
                <?php 
                    $sql = "SELECT * FROM table_monitoring_common_rail_10 order by id desc LIMIT 1";
                    $statement = $connection->query($sql);
                    foreach ($statement as $row){
            ...
            <tr>
                <?php 
                    $sql = "SELECT * FROM table_monitoring_common_rail_11 order by id desc LIMIT 1";
                    $statement = $connection->query($sql);
                    foreach ($statement as $row){
            ...
            <tr>
                <?php 
                    $sql = "SELECT * FROM table_monitoring_common_rail_12 order by id desc LIMIT 1";
                    $statement = $connection->query($sql);
                    foreach ($statement as $row){
